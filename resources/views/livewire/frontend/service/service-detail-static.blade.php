          ...
          >
                    ...
                    <div class="mt-10 rounded-xl border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-800">
                        <p class="font-medium">
                            ...
                            <a href="auth.html" class="font-semibold text-green-700 hover:underline">sign in</a>
                            or
                            <a href="auth.html" class="font-semibold text-green-700 hover:underline">create an
                                account</a>
                            first.
                        </p>
                    </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                <label class="mb-1 block text-sm font-medium text-gray-700">Special Instructions
                                    <span class="text-xs font-normal text-gray-500">(if any)</span></label>
