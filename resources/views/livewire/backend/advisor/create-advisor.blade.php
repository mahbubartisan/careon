    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Create Advisor</li>
            </ol>
        </nav>
    </div>
    <div class="bg-white dark:bg-[#132337] rounded-md px-6 pt-6 pb-3 shadow">
        <h2 class="text-[15px] text-gray-900 dark:text-gray-300 font-medium mb-4">Advisor Info</h2>
        <form method="post" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Designation -->
                <div>
                    <label for="designation" class="block text-sm text-gray-700 dark:text-gray-400">
                        Designation*
                    </label>
                    <input type="text" wire:model="form.designation" id="designation"
                        class="w-full mt-2 px-4 py-2.5 bg-white dark:bg-[#132337] text-gray-800 dark:text-gray-300 text-sm border border-gray-200 rounded-md dark:border-[#233A57] focus:ring-0 focus:outline-none focus:border-blue-600 transition duration-300 ease-in-out" />
            ...
            <div>
                <div wire:ignore>
                    ...
                    <input type="hidden" wire:model="form.detail" id="detail">
                </div>
                <div class="mt-1">
                    @error("form.detail")
