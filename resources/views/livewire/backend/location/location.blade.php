    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Location</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
                ...
                <tbody class="divide-y divide-gray-200 bg-white dark:divide-[#233A57] dark:bg-[#132337]">
                    @forelse ($locationGroups as $index => $group)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">{{ $group->locations->pluck('name')->join(', ') }}</td>
                            <td class="whitespace-nowrap px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    @can("edit location")
                                        <a href="{{ route("edit.location", $group->id) }}"
                                            title="Edit">
                                            <!-- Edit Icon -->
