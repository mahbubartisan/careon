    ...
    <section class="pt-24">
        <div class="mx-auto px-4 text-center">
            ...
            <div class="mb-3 inline-block rounded-full bg-amber-500 px-3 py-1 text-xs font-semibold text-gray-900">
                পোদার স্বাসথ্যসেবা | Professional Healthcare Services
            </div>

            <!-- Main Heading -->
            <h2 class="text-3xl font-extrabold text-gray-900 md:text-5xl">
                Our Services
                <span class="font-extrabold text-gray-900">| আমাদের সেবসমূহ</span>
            </h2>
            ...
            <p class="mx-auto mt-2 max-w-2xl text-lg text-gray-500">
                ...
                All providers are certified, background-checked, and highly trained.
            </p>
